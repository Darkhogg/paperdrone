...
EventResult.prototype.isCancelled = function isCancelled () {
    return this.event._cancelled;
};

EventResult.prototype.isStopped = function isStopped () {
    return this.event._stopped;
};
...
EnhancedEmitter.PRIORITY_VERY_HIGH = -100;
EnhancedEmitter.PRIORITY_HIGH      = -10;
EnhancedEmitter.PRIORITY_NORMAL    = 0;
EnhancedEmitter.PRIORITY_LOW       = +10;
EnhancedEmitter.PRIORITY_VERY_LOW  = +100;
...
EnhancedEmitter.prototype.emit = function (name) {
    ...
    return Promise.reduce(handlers, function (_ignored, obj) {
        if ($evt._stopped) {
            return null;
        }
