...
KeyedStorage.prototype.get = function get (type, key) {
    ...
    self.logger.silly('[KeyedStorage]  finding entry for %s:%s', type, key);
...
KeyedStorage.prototype.list = function list (type) {
    ...
    self.logger.silly('[KeyedStorage]  listing entries for %s', type);
...
KeyedStorage.prototype.set = function set (type, key, value) {
    ...
    self.logger.silly('[KeyedStorage]  setting entry for %s:%s', type, key, value);
...
KeyedStorage.prototype.del = function del (type, key) {
    ...
    self.logger.silly('[KeyedStorage]  removing entry for %s:%s', type, key);
...
KeyedStorage.prototype.empty = function empty (type) {
    ...
    self.logger.silly('[KeyedStorage]  emptying entries for %s', type);
